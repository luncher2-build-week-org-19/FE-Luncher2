...
export const GET_DONATIONS_BY_USER_ID_SUCCESS =
    'GET_DONATIONS_BY_USER_ID_SUCCESS';
export const GET_DONATIONS_BY_USER_ID_FAILURE =
    'GET_DONATIONS_BY_USER_ID_FAILURE';

export const GET_DONATIONS_BY_SCHOOL_ID_START =
    'GET_DONATIONS_BY_SCHOOL_ID_START';
export const GET_DONATIONS_BY_SCHOOL_ID_SUCCESS =
    'GET_DONATIONS_BY_SCHOOL_ID_SUCCESS';
export const GET_DONATIONS_BY_SCHOOL_ID_FAILURE =
...
export const getAllDonations = () => dispatch => {
    ...
    axios({
        ...
        .catch(err =>
            dispatch({ type: GET_ALL_DONATIONS_FAILURE, payload: err })
        );
};
...
export const getDonationsById = id => dispatch => {
    ...
    axios({
        ...
        .catch(err =>
            dispatch({ type: GET_DONATION_BY_ID_FAILURE, payload: err })
        );
};
...
export const getDonationsByUserId = id => dispatch => {
    ...
    axios({
        ...
        .catch(err =>
            dispatch({ type: GET_DONATIONS_BY_USER_ID_FAILURE, payload: err })
        );
};
...
export const getDonationsBySchoolId = id => dispatch => {
    ...
    console.log('get donations by school id 1: ', id);
    axios({
        method: 'get',
        url: `https://luncher-2-bw-19-lambda.herokuapp.com/donations/schools/${id}`
    })
        .then(res => {
            console.log('get donations by school id 2: ', res);
            dispatch({
        ...
        .catch(err =>
            dispatch({ type: GET_DONATIONS_BY_SCHOOL_ID_FAILURE, payload: err })
        );
};
...
export const addNewDonation = (userToken, donation, id) => dispatch => {
    ...
    axios({
        ...
        .then(res => {
            ...
            dispatch({
                type: GET_DONATIONS_BY_SCHOOL_ID_START,
                id: id
            });
            console.log('second dispatch');
        })
        .catch(err =>
            dispatch({ type: ADD_NEW_DONATION_FAILURE, payload: err })
        );
};
