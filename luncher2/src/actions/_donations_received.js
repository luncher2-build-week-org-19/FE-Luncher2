...
export const GET_ALL_DONATED_BY_DONATION_ID_START = 'GET_ALL_DONATED_BY_DONATION_ID_START';
export const GET_ALL_DONATED_BY_DONATION_ID_SUCCESS = 'GET_ALL_DONATED_BY_DONATION_ID_SUCCESS';
export const GET_ALL_DONATED_BY_DONATION_ID_FAILURE = 'GET_ALL_DONATED_BY_DONATION_ID_FAILURE';

export const GET_ALL_DONATED_BY_USER_ID_START = 'GET_ALL_DONATED_BY_USER_ID_START';
export const GET_ALL_DONATED_BY_USER_ID_SUCCESS = 'GET_ALL_DONATED_BY_USER_ID_SUCCESS';
export const GET_ALL_DONATED_BY_USER_ID_FAILURE = 'GET_ALL_DONATED_BY_USER_ID_FAILURE';
...
export const getAllDonations = () => dispatch => {
	...
	axios({
		...
		.catch(err => dispatch({ type: GET_ALL_DONATED_FAILURE, payload: err }));
};
...
export const getAllDonatedByDonationId = id => dispatch => {
	...
	axios({
		...
		.catch(err => dispatch({ type: GET_ALL_DONATED_BY_DONATION_ID_FAILURE, payload: err }));
};
...
export const getAllDonatedByUserId = id => dispatch => {
	...
	axios({
		...
		.catch(err => dispatch({ type: GET_ALL_DONATED_BY_USER_ID_FAILURE, payload: err }));
};
